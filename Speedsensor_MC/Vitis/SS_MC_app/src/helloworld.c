...
int main() {
    ...
    SPEEDSENSOR_mWriteReg(XPAR_SPEEDSENSOR_0_S00_AXI_BASEADDR, SPEEDSENSOR_S00_AXI_SLV_REG1_OFFSET, 0b1111);
    ...
    while (1) {
        ...
        value = SPEEDSENSOR_mReadReg(XPAR_SPEEDSENSOR_0_S00_AXI_BASEADDR, SPEEDSENSOR_S00_AXI_SLV_REG2_OFFSET);
        xil_printf("Pulses: [%u]\n\r", value);
    }
