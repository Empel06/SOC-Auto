namespace eval ::optrace {
  variable script "C:/devWorks/SS_MC_SOC/SS_MC_SOC.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint C:/devWorks/SS_MC_SOC/SS_MC_SOC.runs/impl_1/design_1_wrapper.dcp
  set_property webtalk.parent_dir C:/devWorks/SS_MC_SOC/SS_MC_SOC.cache/wt [current_project]
  set_property parent.project_path C:/devWorks/SS_MC_SOC/SS_MC_SOC.xpr [current_project]
  set_property ip_repo_paths C:/devWorks/ip_repo/SpeedSensor_1_0 [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/devWorks/SS_MC_SOC/SS_MC_SOC.cache/ip [current_project]
