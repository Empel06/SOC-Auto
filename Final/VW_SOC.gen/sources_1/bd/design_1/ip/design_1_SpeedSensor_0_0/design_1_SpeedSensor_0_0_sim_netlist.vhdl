...
-- Date        : Mon May 12 10:50:35 2025
-- Host        : 5CD322B26V running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/devWorks/VW_SOC/VW_SOC/VW_SOC.gen/sources_1/bd/design_1/ip/design_1_SpeedSensor_0_0/design_1_SpeedSensor_0_0_sim_netlist.vhdl
-- Design      : design_1_SpeedSensor_0_0
...
entity design_1_SpeedSensor_0_0_speed_sensor_Core1 is
  port (
    pulse_count_reg : out STD_LOGIC_VECTOR ( 31 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    Clk : in STD_LOGIC;
    last_sensor_state_reg_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Sensor_Pin : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_SpeedSensor_0_0_speed_sensor_Core1 : entity is "speed_sensor_Core1";
end design_1_SpeedSensor_0_0_speed_sensor_Core1;

architecture STRUCTURE of design_1_SpeedSensor_0_0_speed_sensor_Core1 is
  signal last_sensor_state_i_1_n_0 : STD_LOGIC;
  signal last_sensor_state_reg_n_0 : STD_LOGIC;
  signal pulse_count : STD_LOGIC;
  signal \pulse_count[0]_i_2_n_0\ : STD_LOGIC;
  signal \^pulse_count_reg\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \pulse_count_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_1\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_2\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_3\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_4\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_5\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_6\ : STD_LOGIC;
  signal \pulse_count_reg[0]_i_1_n_7\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \pulse_count_reg[0]_i_1\ : label is 11;
...
begin
  pulse_count_reg(31 downto 0) <= \^pulse_count_reg\(31 downto 0);
\__0/i_\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
      I0 => last_sensor_state_reg_0(0),
      I1 => last_sensor_state_reg_n_0,
      I2 => Sensor_Pin,
      O => pulse_count
    );
last_sensor_state_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
      I0 => Sensor_Pin,
      I1 => last_sensor_state_reg_0(0),
      I2 => Q(0),
      I3 => last_sensor_state_reg_n_0,
      O => last_sensor_state_i_1_n_0
    );
last_sensor_state_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => Clk,
      CE => '1',
      D => last_sensor_state_i_1_n_0,
      Q => last_sensor_state_reg_n_0,
      R => '0'
    );
\pulse_count[0]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^pulse_count_reg\(0),
      O => \pulse_count[0]_i_2_n_0\
    );
\pulse_count_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => Clk,
      CE => pulse_count,
      D => \pulse_count_reg[0]_i_1_n_7\,
      Q => \^pulse_count_reg\(0),
      R => Q(0)
    );
\pulse_count_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \pulse_count_reg[0]_i_1_n_0\,
      CO(2) => \pulse_count_reg[0]_i_1_n_1\,
      CO(1) => \pulse_count_reg[0]_i_1_n_2\,
      CO(0) => \pulse_count_reg[0]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \pulse_count_reg[0]_i_1_n_4\,
      O(2) => \pulse_count_reg[0]_i_1_n_5\,
      O(1) => \pulse_count_reg[0]_i_1_n_6\,
      O(0) => \pulse_count_reg[0]_i_1_n_7\,
      S(3 downto 1) => \^pulse_count_reg\(3 downto 1),
      S(0) => \pulse_count[0]_i_2_n_0\
    );
...
\pulse_count_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(15 downto 12)
    );
...
\pulse_count_reg[14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pulse_count_reg[15]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pulse_count_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(19 downto 16)
    );
...
\pulse_count_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => Clk,
      CE => pulse_count,
      D => \pulse_count_reg[0]_i_1_n_6\,
      Q => \^pulse_count_reg\(1),
      R => Q(0)
    );
\pulse_count_reg[20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pulse_count_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(23 downto 20)
    );
...
\pulse_count_reg[23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pulse_count_reg[24]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\pulse_count_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(27 downto 24)
    );
...
\pulse_count_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(31 downto 28)
    );
...
\pulse_count_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(7 downto 4)
    );
...
\pulse_count_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => \^pulse_count_reg\(11 downto 8)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_SpeedSensor_0_0_SpeedSensor_slave_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_SpeedSensor_0_0_SpeedSensor_slave_lite_v1_0_S00_AXI : entity is "SpeedSensor_slave_lite_v1_0_S00_AXI";
end design_1_SpeedSensor_0_0_SpeedSensor_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of design_1_SpeedSensor_0_0_SpeedSensor_slave_lite_v1_0_S00_AXI is
...
Core1: entity work.design_1_SpeedSensor_0_0_speed_sensor_Core1
     port map (
      Clk => Clk,
      Q(0) => slv_reg0(0),
      Sensor_Pin => Sensor_Pin,
      last_sensor_state_reg_0(0) => slv_reg1(0),
      pulse_count_reg(31 downto 0) => pulse_count_reg(31 downto 0)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_SpeedSensor_0_0_SpeedSensor is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_SpeedSensor_0_0_SpeedSensor : entity is "SpeedSensor";
end design_1_SpeedSensor_0_0_SpeedSensor;

architecture STRUCTURE of design_1_SpeedSensor_0_0_SpeedSensor is
begin
SpeedSensor_slave_lite_v1_0_S00_AXI_inst: entity work.design_1_SpeedSensor_0_0_SpeedSensor_slave_lite_v1_0_S00_AXI
     port map (
      Clk => Clk,
      Sensor_Pin => Sensor_Pin,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_SpeedSensor_0_0 is
  port (
    Clk : in STD_LOGIC;
    Sensor_Pin : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_SpeedSensor_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_SpeedSensor_0_0 : entity is "design_1_SpeedSensor_0_0,SpeedSensor,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_SpeedSensor_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_SpeedSensor_0_0 : entity is "SpeedSensor,Vivado 2024.1";
end design_1_SpeedSensor_0_0;

architecture STRUCTURE of design_1_SpeedSensor_0_0 is
...
U0: entity work.design_1_SpeedSensor_0_0_SpeedSensor
     port map (
      Clk => Clk,
      Sensor_Pin => Sensor_Pin,
