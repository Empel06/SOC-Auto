...
HD_PWD='C:/devWorks/VW_SOC/VW_SOC/VW_SOC.runs/design_1_ultrasoon_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ultrasoon_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ultrasoon_0_0.tcl
