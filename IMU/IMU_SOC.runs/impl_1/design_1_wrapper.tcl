namespace eval ::optrace {
  variable script "C:/devWorks/IMU_SOC/IMU_SOC.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/12302093/AppData/Roaming/Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part tul.com.tw:pynq-z2:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/devWorks/IMU_SOC/IMU_SOC.cache/wt [current_project]
  set_property parent.project_path C:/devWorks/IMU_SOC/IMU_SOC.xpr [current_project]
  set_property ip_output_repo C:/devWorks/IMU_SOC/IMU_SOC.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/devWorks/IMU_SOC/IMU_SOC.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/devWorks/IMU_SOC/IMU_SOC.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/devWorks/IMU_SOC/IMU_SOC.srcs/constrs_1/new/IO_Ports.xdc
